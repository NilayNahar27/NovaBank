...
import { maskCard } from '../utils/format.js'
...
export default function SignupWizard() {
  ...
  const finish = handleSubmit(async (values) => {
    ...
    try {
      ...
      push(`Account ready. Card ${maskCard(data.account.cardNumber)}`)
  ...
  return (
    <AuthLayout
      title="Create your NovaBank account"
      subtitle="A guided 3-step flow mirrors legacy desktop onboarding — with modern validation, secure PIN hashing, and instant virtual card issuance."
    >
